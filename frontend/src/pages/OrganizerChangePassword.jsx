...
function OrganizerChangePassword() {
  ...
  useEffect(() => {
    apiFetch('/organizer/me').then(async (res) => {
      if (!res.ok) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      const res = await apiFetch('/organizer/change-password', {
        method: 'POST',
      ...
      <main className="app">
        ...
        <div className="setup-card">
          ...
          <form className="setup-form" onSubmit={handleSubmit} noValidate>
            <div className="field">
              <label htmlFor="org-cp-current">Current Password</label>
              <PasswordInput
                id="org-cp-current"
            ...
            <div className="field">
              <label htmlFor="org-cp-new">New Password</label>
              <PasswordInput
                id="org-cp-new"
                value={newPassword}
...
export default OrganizerChangePassword
